...
public abstract class DbPostgres extends DbDefinitionBase implements HandicapDatabaseG {
	...
	protected final static String CHECKUNDELIVEREDSQL = "SELECT to_regclass('public.undelivered')";
  	protected final static String CHECKHANDICAPSQL = "SELECT table_name FROM information_schema.tables WHERE table_name in ('golfer', 'course', 'scores', 'ratings', 'login', 'groups', 'member');";
