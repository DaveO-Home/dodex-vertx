...
public class HandicapDatabaseH2G extends DbH2 {
  protected static final Logger logger = LoggerFactory.getLogger(HandicapDatabaseH2G.class.getName());
  ...
  public HandicapDatabaseH2G() throws InterruptedException, IOException, SQLException {
    super();
