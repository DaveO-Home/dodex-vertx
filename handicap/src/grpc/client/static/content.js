				...
				<footer class="dodex-footer  mt-auto py-3" style="width:95%">
						<div class="footer-col col-sm-12">
							<ul class="list-inline" class="w-100">
								...
								<li class="list-inline-item"><a class="btn-social btn-outline" href="https://www.pgatour.com/" target="_"><i class="fas fa-golf-ball"></i></a></li>
								<li class="float-end">doDex &copy; 2022</li>
							</ul>
						</div>
				</footer>`
			}
