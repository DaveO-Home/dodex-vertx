...
public class DodexDatabaseOracle extends DbOracle implements Serializable {
  ...
  public void entityManagerSetup(SessionFactory emf) {
    DodexDatabaseOracle.emf = emf;
  }
  ...
  public void entityManagerSetup() {
    ...
    DodexDatabaseOracle.entityManager = Objects.requireNonNull(sessionFactory).createEntityManager();
