...
val MEMBER__MEMBER_GROUP_ID_FOREIGN: ForeignKey<MemberRecord, GroupsRecord> = Internal.createForeignKey(Member.MEMBER, DSL.name("member_group_id_foreign"), arrayOf(Member.MEMBER.GROUP_ID), golf.handicap.generated.keys.GROUPS_PKEY, arrayOf(Groups.GROUPS.ID), true, ForeignKeyRule.NO_ACTION, ForeignKeyRule.NO_ACTION)
val RATINGS__FK_COURSE_RATINGS: ForeignKey<RatingsRecord, CourseRecord> = Internal.createForeignKey(Ratings.RATINGS, DSL.name("fk_course_ratings"), arrayOf(Ratings.RATINGS.COURSE_SEQ), golf.handicap.generated.keys.COURSE_PKEY, arrayOf(Course.COURSE.COURSE_SEQ), true, ForeignKeyRule.NO_ACTION, ForeignKeyRule.NO_ACTION)
val SCORES__FK_COURSE_SCORES: ForeignKey<ScoresRecord, CourseRecord> = Internal.createForeignKey(Scores.SCORES, DSL.name("fk_course_scores"), arrayOf(Scores.SCORES.COURSE_SEQ), golf.handicap.generated.keys.COURSE_PKEY, arrayOf(Course.COURSE.COURSE_SEQ), true, ForeignKeyRule.NO_ACTION, ForeignKeyRule.NO_ACTION)
val SCORES__FK_GOLFER_SCORES: ForeignKey<ScoresRecord, GolferRecord> = Internal.createForeignKey(Scores.SCORES, DSL.name("fk_golfer_scores"), arrayOf(Scores.SCORES.PIN), golf.handicap.generated.keys.GOLFER_PKEY, arrayOf(Golfer.GOLFER.PIN), true, ForeignKeyRule.NO_ACTION, ForeignKeyRule.NO_ACTION)
