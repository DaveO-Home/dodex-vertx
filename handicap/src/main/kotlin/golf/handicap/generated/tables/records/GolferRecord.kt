...
open class GolferRecord() : UpdatableRecordImpl<GolferRecord>(Golfer.GOLFER), Record9<String?, String?, String?, Float?, String?, String?, Boolean?, Boolean?, BigDecimal?> {
    ...
    override fun valuesRow(): Row9<String?, String?, String?, Float?, String?, String?, Boolean?, Boolean?, BigDecimal?> = super.valuesRow() as Row9<String?, String?, String?, Float?, String?, String?, Boolean?, Boolean?, BigDecimal?>
    ...
    override fun values(value1: String?, value2: String?, value3: String?, value4: Float?, value5: String?, value6: String?, value7: Boolean?, value8: Boolean?, value9: BigDecimal?): GolferRecord {
        this.value1(value1)
        this.value2(value2)
        this.value3(value3)
        this.value4(value4)
     ...
     */
    constructor(pin: String? = null, firstName: String? = null, lastName: String? = null, handicap: Float? = null, country: String? = null, state: String? = null, overlapYears: Boolean? = null, `public`: Boolean? = null, lastLogin: BigDecimal? = null): this() {
        this.pin = pin
