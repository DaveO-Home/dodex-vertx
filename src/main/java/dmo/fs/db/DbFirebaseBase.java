...
public abstract class DbFirebaseBase {
    ...
    public FirebaseUser updateUser(ServerWebSocket ws, FirebaseUser firebaseUser)
        ...
        ApiFuture<WriteResult> apiFuture = userDoc.update("lastLogin", Timestamp.now(), "ip", firebaseUser.getIp());
	...
	public Future<FirebaseMessage> addMessage(ServerWebSocket ws, MessageUser messageUser, String message,
        ...
        undelivered.forEach(user -> {
            ...
            try {
                ...
                CollectionReference messageDoc = dbf.collection("messages").document(firebaseMessage.getName()).collection("documents");
	...
	public Future<FirebaseUser> selectUser(MessageUser messageUser, ServerWebSocket ws)
        ...
        DocumentReference documentReference = dbf.collection("users").document(messageUser.getName());
