...
public class OpenApiRouterMongo {
  private static final Logger logger = LoggerFactory.getLogger(OpenApiRouterMongo.class.getName());
      ...
      for (OpenAPIRoute openApiRoute : routesList) {
        if ("groupById".equals(openApiRoute.getOperation().getOperationId())) {
          openApiRoute.addHandler(routingContext -> {
            ...
            GroupOpenApi groupOpenApi = new GroupOpenApiMongo();;
